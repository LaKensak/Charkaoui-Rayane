...
export const myProjects = [
...
},
   {
    ...
    desc: 'Une application web fictif permettant aux clients de consulter et filtrer un catalogue complet de meubles et accessoires de décoration par catégories.',
    subdesc: 'Réalisé dans le cadre de mes études, ce projet pédagogique m\'a permis d\'appliquer le pattern MVC (Modèle-Vue-Contrôleur) en PHP natif. L\'application web comprend un frontend en HTML5/CSS3 offrant une interface conviviale pour parcourir et filtrer le catalogue de mobilier. La base de données MySQL gère les produits. Ce projet m\'a permis de mettre en pratique les concepts de développement web appris en cours tout en travaillant sur un cas concret d\'application.',
    apprentissage: 'En réalisant ce projet, j\'ai compris l\'importance des design patterns comme le MVC dans la structuration d\'applications web complexes. J\'ai mis en œuvre les principes de la programmation orientée objet en PHP en utilisant des setters et getters. Cette expérience m\'a permis de passer de la théorie à la pratique en concevant une architecture maintenable et évolutive, compétence fondamentale pour tout développeur.',
    ...
    {
    title: 'Bibliothèque - Système de Gestion',
