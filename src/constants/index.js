...
export const myProjects = [
    ...
    },
    {
        ...
        apprentissage: 'En développant ce portail F1, j\'ai découvert l\'importance d\'une structure de base de données bien conçue pour gérer efficacement le contenu dynamique. J\'ai approfondi mes connaissances en PHP et appris à créer un système de gestion de contenu personnalisé, ce qui m\'a permis de comprendre les principes fondamentaux qui sous-tendent les CMS comme WordPress.',
