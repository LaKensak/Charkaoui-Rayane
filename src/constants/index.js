...
export const myProjects = [
    {
        ...
        subdesc: 'Ce projet a été développé avec une architecture moderne combinant React.js et TypeScript pour le frontend, et Django pour le backend. L\'interface utilisateur, conçue avec TailwindCSS, offre une expérience fluide et responsive permettant aux couples de suivre leur progression, d\'accéder à des ressources adaptées et de participer à des exercices interactifs. Le backend Django gère l\'authentification sécurisée, le stockage des données utilisateur et fournit une API REST pour la communication avec le frontend. Ce projet m\'a permis de découvrir l\'intégration d\'un frontend React avec un backend Django, notamment les défis de la communication API REST. J\'ai appris à gérer l\'authentification des utilisateurs entre les deux environnements et à mettre en place une architecture modulaire. L\'utilisation de TypeScript a renforcé ma compréhension du typage fort et de la prévention des erreurs en phase de développement.',
    ...
    },
   {
        ...
        subdesc: 'Ce projet académique a été développé en C# dans le cadre de ma formation, utilisant le framework .NET avec Windows Forms pour l\'interface utilisateur. La base de données MySQL stocke l\'ensemble des informations clients, véhicules et transactions. Le système comprend également une application console tierce innovante qui permet de convertir du texte brut en requêtes SQL, simplifiant considérablement le travail des employés peu familiers avec le langage SQL. Cette fonctionnalité permet aux employé(e)s d\'entrer des descriptions en langage naturel qui sont automatiquement transformées en requêtes exploitables par le système. L\'application principale gère le cycle commercial complet : création de fiches clients, enregistrement des véhicules, suivi des ventes, le tout suivant une architecture en couches qui respecte les principes de la programmation orientée objet. Ce projet m\'a initié à la programmation orientée objet approfondie en C# et à la conception d\'interfaces graphiques avec Windows Forms. J\'ai découvert les principes d\'architecture en couches (présentation, métier, accès aux données) et comment ils facilitent la maintenance du code. La création de l\'outil de conversion texte-SQL m\'a fait comprendre les bases du traitement du langage naturel et m\'a permis d\'explorer les possibilités d\'automatisation pour simplifier l\'expérience utilisateur.',
    ...
    },
    {
        ...
        subdesc: 'Réalisé dans le cadre de mes études, ce projet pédagogique m\'a permis d\'appliquer le pattern MVC (Modèle-Vue-Contrôleur) en PHP natif. L\'application web e-commerce comprend un frontend en HTML5/CSS3/JavaScript offrant une interface conviviale pour parcourir et filtrer le catalogue de mobilier. La base de données MySQL gère les produits. Ce projet m\'a permis de mettre en pratique les concepts de développement web appris en cours tout en travaillant sur un cas concret d\'application e-commerce. J\'ai découvert l\'importance des design patterns, notamment le MVC, pour structurer efficacement une application web. Ce projet m\'a appris à séparer clairement les responsabilités dans le code (données, logique métier, présentation) et à comprendre comment ces couches interagissent. J\'ai également approfondi mes connaissances en PHP natif sans framework, ce qui m\'a donné une meilleure compréhension des mécanismes fondamentaux du développement web avant d\'aborder des frameworks plus complexes.',
