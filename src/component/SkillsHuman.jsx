...
const SkillsHuman = ({ animationName = 'idle', currentSkill = null, ...props }) => {
    ...
    const starfield = useMemo(() => {
        ...
        for (let i = 0; i < starsCount; i++) {
            ...
            temp.push({ position: [x, y, z], size, blinkSpeed, blinkOffset });
        }
        return temp;
    }, []);

    // Génération des nébuleuses pour le fond
    const nebulasCount = 10;
    ...
    const galaxyParticlesCount = 3000;
    ...
    return (
        <>
            ...
            <fog attach="fog" args={['#000B18', 15, 50]} />
            ...
            {/* Galaxie spirale en arrière-plan */}
